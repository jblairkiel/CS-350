...
public class BuildingBlock {
	...
	public void draw(Graphics g) {
		...
		g.setColor(Color.black);
			//g.fillOval(X + (Width/8), Y + (7*Height/8), (Width/3), (Height/3));
			//g.fillOval(X + (7*Width/8), Y + (7*Height/8), (Width/3), (Height/3));
			g.fillOval(X, Y + (13*Height/16), (Width/3), (Height/3));
			g.fillOval(X + (43*Width/64), Y + (13*Height/16), (Width/3), (Height/3));
